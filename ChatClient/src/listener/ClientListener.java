...
public class ClientListener implements ActionListener {
	...
	private void sendFileMessage() {
		...
		if (toSomebody.equalsIgnoreCase("所有人")) {
			...
			try {
				...
				output.flush();
				output.writeObject(fileConvertToByteArray(file));
				output.flush();
			} catch (Exception e) {
	...
	public void Connect() {
		...
		try {
			...
			recvThread = new ClientReceiveThread(socket, output, input, mainFrame.combobox, mainFrame.messageShow,
